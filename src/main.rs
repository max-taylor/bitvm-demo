...
use utils::{challenge_hashes::ChallengeHashes, conversions::number_to_bool_array};
...
fn main() {
    ...
    let mut challenge_hashes = ChallengeHashes::new();
    ...
    for i in 0..bisection_length {
        ...
        let (challenge_hashes, challenge_preimages) =
            challenge_hashes.generate_challenge_hashes(circuit.gates.len());
